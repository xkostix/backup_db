...
Если объём полного бэкапа бобьшой, и полное резервное копирование занимает много времени или ресурсов, можно использовать комбинацию полного и инкрементного/дифференциального резервного копирования.
